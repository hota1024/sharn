 ...
 */
export const TermsOfUsePage: NextPage = () => {
  return (
    <>
      <PageHead title="利用規約" />
        ...
        <Container>
          <Content>
            ...
            <Card style={{ padding: '16px' }}>
              <h2>利用規約</h2>
              この利用規約（以下，「本規約」といいます。）は，sharn（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
              <br />
              <h3>第1条（適用）</h3>
